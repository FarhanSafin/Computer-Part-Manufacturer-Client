...
const NotFound = () => {
    return (
        <div className='notfound flex'>
            <svg className='vectoricon ml-64 mt-20' width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="text-3xl md:mx-96 md:mt-64">
        <h1>404 No Page Found</h1>  
         <h3>Lets Go <Link className='text-center mt-5 text-secondary font-bold' to="/home">Home</Link></h3> 
    </div>
    </div>
    );
};
