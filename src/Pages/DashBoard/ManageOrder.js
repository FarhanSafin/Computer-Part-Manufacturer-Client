...
const ManageOrder = () => {
    ...
    const {data: orders, isLoading, refetch} = useQuery('orders', () => fetch('https://computer-part-seller.onrender.com/allorders', {
        method: 'GET',
        headers:{
    ...
    const updateOrder = id => {
      fetch(`https://computer-part-seller.onrender.com/updatestatus/${id}`,{
        method: 'PUT',
        headers: {
          authorization: `Bearer ${localStorage.getItem('accessToken')}`
        },
