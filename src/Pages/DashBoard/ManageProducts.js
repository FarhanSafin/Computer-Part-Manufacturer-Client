...
const ManageProducts = () => {
  ...
  <table class="table w-full">
    ...
    <tbody>
    {
        ...
        <td>    
        <label onClick={() => setDeletingProduct(part)} for="delete-confirm-modal" class="btn btn-outline btn-warning">        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
